...
async def main(args):
    ...
    for i in range(args.num_sample):
        ...
        # generate feedback
        all_feedback_result_list = await generate_concurrently(all_model_inputs, 0, None, args, True)

        ## NOTE: Input file of the Selector should be 'all_feedback.json'
        save_json(os.path.join(save_path, "all_feedback.json"), all_feedback_result_list)
