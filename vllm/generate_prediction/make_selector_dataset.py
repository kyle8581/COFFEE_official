...
def make_list(train_dataset, eval_dataset):
    ...
    for data in train_dataset:
        ...
        positive_pair = {"text": valuable_text, "label": 1}
        negative_pair = {"text": invaluable_text, "label": 0}
        make_train_list.append(positive_pair)
        make_train_list.append(negative_pair)
    ...
    for data in eval_dataset:
        ...
        positive_pair = {"text": valuable_text, "label": 1}
        negative_pair = {"text": invaluable_text, "label": 0}
        make_eval_list.append(positive_pair)
        make_eval_list.append(negative_pair)
...
def main(args):
    ...
    with open(os.path.join(args.data_dir, "selector_train.json"), "w") as f:
        json.dump(train_save_dict, f)
    with open(os.path.join(args.data_dir, "selector_eval.json"), "w") as f:
